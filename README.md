...
<details>
<summary><strong>Can I compare the same law across languages?</strong></summary>
...
You can select any of the 24 official EU languages; English, German and French
are just examples. The original dataset and usual workflow stay unchanged.
Missing or unsupported HTML versions are reported, and some consolidated texts
support articles only. See the
[multilingual extraction guide](https://github.com/tseidl/eurlex-builder/blob/main/docs/multilingual-extraction.md)
for output details and an example joining matching passages.
